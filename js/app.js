...
export default class Sketch {
    ...
    mouseEvents() {
        window.addEventListener('mousemove', (e) => {
            ...
            let delayLerp = new THREE.Vector3(mx, my, 0);
            this.camera.position.lerp(delayLerp, 0.05);

            let oldLerp = delayLerp;

            // this.camera.position.set(mx, my, 0);

            // let r = (x * -1) + (1 - x) + 2 + x;
            // let r = x;
            // this.camera.rotation.set(0, 0, r);            
